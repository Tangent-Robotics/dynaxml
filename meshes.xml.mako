...
<%def name="get_servo_meshes(servo)">
  ...
  ${box_mesh(servo.type+"_bracket", servo.x_dim+0.006, 0.002, servo.bracket_width)}
  ${box_mesh(servo.type+"_bracket_side", 0.002, servo.bracket_clearance, servo.bracket_width)}
